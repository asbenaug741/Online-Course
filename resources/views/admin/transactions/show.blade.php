    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="flex flex-row gap-x-10">
                    ...
                    <div class="flex flex-col gap-y-10">    
                        ...
                        <div>
                            ...
                            <span class="py-2 px-2 rounded-full text-white bg-green-500 text-sm">ACTIVE</span>
                            @else
                            <span class="py-2 px-2 rounded-full text-white bg-orange-500 text-sm">PENDING</span>
                            @endif
                        </div>
                        <div>
                        ...
                        <div>
                            <p class="text-slate-500 text-sm">Start Subscribe</p>
                ...
                <hr class="my-5">
                @if ($subscribeTransaction->is_paid)
                    <a href="{{ route('admin.subscribe_transactions.index') }}" class="text-sm w-fit font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                        &#8592; Back To Approve Menu
                    </a>
                @else
